                    ...
                    <div class="card shadow-lg">
                            ...
                            ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="contact" type="text" class="form-control" name="contact" value=""
                                        placeholder="Please Enter Contact Number" pattern="07[3|5|6|7|8|9][0-9]{8}"
                                        required autofocus>
                                    <?php 
                        ...
                        <!-- <div class="card-footer py-3 border-0">
                            <div class="text-center">
                                Already have an account? <a href="login.php" class="text-dark">Admin Home Page</a>
                            </div>
                        </div> -->
                    </div>
                    <div class="text-center mt-5 mb-3 text-muted">
                        Copyright &copy; 2022 &mdash; Online Public Transport Courier System
                    </div>
                </div>
            </div>
        </div>
