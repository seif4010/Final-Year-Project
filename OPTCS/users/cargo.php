<?php 
    ...
    //   header('location: myorder.php');
        ...
        if(!($scity == $rcity)){
            ...
            if($scity == 'Nairobi' || $rcity == 'Nairobi'){

                if(($scity == 'Nairobi' && $rcity == 'Mombasa') || ($scity == 'Mombasa' && $rcity == 'Nairobi')){
                    $basic_price = 1500;
                } else if(($scity == 'Nanyuki' && $rcity == 'Nairobi') || ($scity == 'Nanyuki' && $rcity == 'Nairobi')){
                    $basic_price = 1200;
                } else if(($scity == 'Nairobi' && $rcity == 'Busia') || ($scity == 'Busia' && $rcity == 'Nairobi')){
                    $basic_price = 700;
                } else if(($scity == 'Nairobi' && $rcity == 'Kisumu') || ($scity == 'Kisumu' && $rcity == 'Nairobi')){
                    $basic_price = 900;
                } else if(($scity == 'Nairobi' && $rcity == 'Mandera') || ($scity == 'Mandera' && $rcity == 'Nairobi')){
                    $basic_price = 800;
                } else if(($scity == 'Nairobi' && $rcity == 'Garissa') || ($scity == 'Garissa' && $rcity == 'Nairobi')){
                    $basic_price = 1000;
                } else if(($scity == 'Nairobi' && $rcity == 'Machakos') || ($scity == 'Machakos' && $rcity == 'Nairobi')){
                    $basic_price = 600;
                } else if (($scity == 'Nairobi' && $rcity == 'Kericho') || ($scity == 'Kericho' && $rcity == 'Nairobi')) {
                    $basic_price = 1600;
                } else if (($scity == 'Nairobi' && $rcity == 'Nanyuki') || ($scity == 'Nanyuki' && $rcity == 'Nairobi')) {
                    $basic_price = 700;
                } else if (($scity == 'Nairobi' && $rcity == 'Kiambu') || ($scity == 'Kiambu' && $rcity == 'Nairobi')) {
                    $basic_price = 1500;
                }
                ...
                $error = "Please Choose One City  To Order Cargo! ";
            ...
            <div class="lg-offset-2 col-lg-8 col-md-12">
                <div class="sender-details mt-5 p-5" style="background-color: whitesmoke;">
                    ...
                    <form method="POST" action="">
                        ...
                        <h5 style="font-weight: bold;" class="text-center mb-5 mt-5">Cargo Details</h5>

                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Parcel Weight:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Parcel Length:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Parcel Width:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Parcel Height:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Parcel Quantity:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Parcel Type:</label>
                                </div>
                                <div class="col-md-9">
                                    <select class="form-control" name="ctype">
                                        ...
                                        <option value="">Shounen Jump Manga</option>
                                        <option value="">Funictures</option>
                                        <option value="">Medical Supplies</option>
                                        <option value="">Matresses</option>
                                        <option value="">Bed</option>
                                        <option value="">Food Stuff</option>
                                        <option value="">Kitchenware</option>
                                        <option value="">Shoes and Bags</option>
                                        <option value="">Books</option>
                                        <option value="">Cotton Candy</option>
